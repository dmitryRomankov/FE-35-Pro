...
const PostControl = ({ sizeIcon }: IPostControl) => {
	return (
		<div className={styles.container}>
			...
			<div className={styles.controls}>
				<svg xmlns="http://www.w3.org/2000/svg" width={sizeIcon} height={sizeIcon} viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M9 4h6a2 2 0 0 1 2 2v14l-5 -3l-5 3v-14a2 2 0 0 1 2 -2"></path></svg>
